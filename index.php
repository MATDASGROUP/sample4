		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over $100.00</h6>	
				</div>
			</div><!-- .col -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Mathematics Textbooks</h3>
...
?>
	...
	<section>
		<h2 class="test-title">Testimonies</h2>
		<div class="test-contain" style="display: flex; justify-contents: space-arround; padding: 20px;" >
			<div class="column1">
				<img src="dr. fakindele.jpg" alt="" width="200px">
				<h3>Dr. Fakindele</h3>
				<p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
			</div>
			<div class="column1">
			<img src="dr. tunde.jpg" alt="" width="200px">
				<h3>Dr. Tunde</h3>
				<p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
			</div>
			<div class="column1">
			<img src="alagba rotimi.jpg" alt="" width="200px">
				<h3>Alagba Rotimi</h3>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
			</div>
		</div>
